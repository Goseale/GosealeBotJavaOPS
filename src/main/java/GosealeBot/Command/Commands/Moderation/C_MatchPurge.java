...
public class C_MatchPurge implements ICommand {
        ...
        channel.getIterableHistory()
                ...
                .thenApplyAsync((messages) -> {
                    List<Message> goodMessages = messages.stream()
                            ...
                            .filter(((message) -> {
                                return message.getContentRaw().contains(string);
                            }))
    ...
    public String getHelp() {
        return "Bulk delete messages that contains a given string in a text channel\n" +
                "Usage: " + Configuration.get("prefix") +getName()+ " [amount] [String]";
    }
